        ...
        <div className="relative min-h-screen p-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex-1 bg-gray-200/50 rounded-lg shadow-md p-6 overflow-auto">
                    <h1 className="text-[42px] font-bold text-left text-gray-800 mb-4">{title}</h1>
                    <h2 className="text-[22px] font-bold text-left text-gray-500 mb-4">{description}</h2>
                ...
                <div className="w-full md:w-1/3 space-y-4">
                    ...
                    <div className="flex items-center space-x-10 p-4 bg-gray-200/50 backdrop-blur-md shadow-sm rounded-lg hover:shadow-lg hover:backdrop-blur-xl hover:bg-gray-200/80 transition-all duration-300 ease-in-out">
                    ...
                    <div className="p-4">
                    <div className="text-md text-slate-800 flex items-center space-x-2 mt-4">
